...
const sampleQuestions = [
  "How do I start by restarent business",
  "What is the process to start businees in NY?",
  "How much money a restaurant make in NY?",
]
          ...
          >
            ...
            {!messages.length && (
              <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="w-full mt-6 flex flex-row justify-center gap-2"
              >
